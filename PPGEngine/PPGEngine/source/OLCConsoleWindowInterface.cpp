...
CHAR_INFO olcConsoleGameEngineOOP::GetColour(float lum)
{
	short bg_col, fg_col;
	wchar_t sym;
...
void olcConsoleGameEngineOOP::DrawTriangle(int x1, int y1, int x2, int y2, int x3, int y3, short c, short col)
{
...
void olcConsoleGameEngineOOP::FillTriangle(int x1, int y1, int x2, int y2, int x3, int y3, short c, short col)
{
...
void olcConsoleGameEngineOOP::TexturedTriangle(int x1, int y1, float u1, float v1, float w1, int x2, int y2, float u2, float v2, float w2, int x3, int y3, float u3, float v3, float w3, float* depthBuffer, olcSprite * tex)
{
	if (y2 < y1)
	{
		swap(y1, y2);
